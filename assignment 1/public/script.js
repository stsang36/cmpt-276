...
const listID = ['a-plusList', 'aList', 'a-minusList', 'b-plusList', 'bList', 'b-minusList', 'c-plusList', 'cList', 'c-minusList', 'dList', 'fList'];
            ...
            switch(id) {
                ...
                case 'a-minus':
                    if (myNumber <= dict['b-plus'] || myNumber >= dict['a']) {
                        alert("A- cannot be less than B+ or greater than A!");
                    }
                    else {
                ...
                case 'b-plus':
                    if (myNumber <= dict['b'] || myNumber >= dict['a-minus']) {
                        alert("B+ cannot be less than B or greater than A-!");
                    }
                    else {
                ...
                case 'b':
                    if (myNumber <= dict['b-minus'] || myNumber >= dict['b-plus']) {
                        alert("B cannot be less than B- or greater than B+!");
                    }
                    else {
                        dict['b'] = myNumber;
                    }
                ...
                case 'b-minus':
                    if (myNumber <= dict['c-plus'] || myNumber >= dict['b']) {
                        alert("B- cannot be less than C+ or greater than B!");
                    }
                    else {
                ...
                case 'c-plus':
                    if (myNumber <= dict['c'] || myNumber >= dict['b-minus']) {
                        alert("C+ cannot be less than C or greater than B-!");
                    }
                    else {
                ...
                case 'c':
                    if (myNumber <= dict['c-minus'] || myNumber >= dict['c-plus']) {
                        alert("C cannot be less than C- or greater than C+!");
                    }
                    else {
                        dict['c'] = myNumber;
                    }
                ...
                case 'c-minus':
                    if (myNumber <= dict['d'] || myNumber >= dict['c']) {
                        alert("C- cannot be less than D or greater than C!");
                    }
                    else {
...
function refreshValues() {
    ...
    listID.forEach((element) => {document.getElementById(element).innerHTML = '';});

    grades.forEach((element) => {
        if (element <= dict['Max'] && element >= 0) {
            if (element >= dict['a-plus']) {
                document.getElementById('a-plusList').innerHTML += "O";
            } else if (element >= dict['a']) {
                document.getElementById('aList').innerHTML += "O";
            } else if (element >= dict['a-minus']) {
                document.getElementById('a-minusList').innerHTML += "O";
            } else if (element >= dict['b-plus']) {
                document.getElementById('b-plusList').innerHTML += "O";
            } else if (element >= dict['b']) {
                document.getElementById('bList').innerHTML += "O";
            } else if (element >= dict['b-minus']) {
                document.getElementById('b-minusList').innerHTML += "O";
            } else if (element >= dict['c-plus']) {
                document.getElementById('c-plusList').innerHTML += "O";
            } else if (element >= dict['c']) {
                document.getElementById('cList').innerHTML += "O";
            } else if (element >= dict['c-minus']) {
                document.getElementById('c-minusList').innerHTML += "O";
            } else if (element >= dict['d']) {
                document.getElementById('dList').innerHTML += "O";
